...
public class MyLinkedList<E> {
    ...
    // Phuương thức thêm đối tượng vào MyLinkedlist ở vị trí index
    public void add(int index, E data) {
        Node temp = head;
        Node holder;
        // chạy đến vị trí index-1
        for (int i = 0; i < index - 1 && temp.next != null; i++) {
            temp = temp.next;
        }
        //holder tham chiếu đến vị trí index
        holder = temp.next;
    ...
    public void addLast(E data) {
        //khai báo Node temp trỏ đến node head
        Node temp = head;
    ...
    public Object get(int index) {
        //khai báo Node temp trỏ đến node head
        Node temp = head;
        // chạy đến vị trí index
        for (int i = 0; i < index; i++) {
            temp = temp.next;
        }
        // trả về data ở vị trí index
        return temp.data;
    }
    /**
