                    ...
                    <c:forEach var="customer" items="${customerList}">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/customer?actionFurama=delete&id=${customer.id}"  onclick="setCustomerId('${customer.id}')" data-target="#deleteCustomerModal" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE5C9;</i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
