    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-xs-3">
                        <h2>List <b>Customer</b></h2>
                    </div>
                    <div class="col-xs-4">
                        <input type="text" name="nameCustomer" class="form-control" id="keywordCustomerDisplay" placeholder="Search by Name">
                        <input style="margin-left: 130px; margin-top:3px" type="button" value="Search" class="btn btn-primary" onclick="submitFormSearchCustomer()">
                    </div>
                    <div class="col-xs-5">
                        <a href="/customer?actionFurama=showCreateNewCustomer" class="btn btn-primary"><i class="material-icons">&#xE147;</i> <span>Create New Customer</span></a>
