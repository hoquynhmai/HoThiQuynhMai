        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        <a href="/employee?actionFurama=employeeList" class="btn btn-primary"><i class="material-icons">&#xE147;</i> <span>Back to Employee List </span></a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <c:forEach var="employee" items="${employeeList}">
                        <tr>
                            ...
                            <td>
                                <a href="/employee?actionFurama=showEditEmployee&id=${employee.id}" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
