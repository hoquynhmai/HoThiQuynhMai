...
<div class="container">
    ...
    <form action="/product" method="post">
        <input type="hidden" name="actionLand" value="updateProduct"/>
        ...
        <div class="form-group has-error">
            ...
            <input type="date" class="form-control" name="quantity" id="quantity" value="${product.quantity}" required/>
            <p>${messageQuantity}</p>
        </div>
        ...
        <div class="form-group has-error">
            ...
            <input type="date" class="form-control" name="description" id="description" value="${product.description}" required/>
        </div>
