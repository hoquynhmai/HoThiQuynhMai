    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (actionProduct) {
            ...
            case "searchProduct":
                ...
                break;
            case "searchProductPrice":
                searchProductPrice(request, response);
                break;
        }
    }
...
//        RequestDispatcher dispatcher = request.getRequestDispatcher("view/demo.jsp");
    ...
    private void searchProductPrice(HttpServletRequest request, HttpServletResponse response) {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("view/search-product-price.jsp");
        try {
            dispatcher.forward(request, response);
        } catch (ServletException | IOException e) {
            e.printStackTrace();
