...
public class ProductDAOImpl implements ProductDAO {
    ...
    private static final String SELECT_PRODUCTS_BY_PRICE = "select * from product where price like ?";
    ...
    public List<Product> findAllProduct() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                String color = resultSet.getString("color_id");
    ...
    public List<Color> findAllColor() {
        BaseDAO baseDAO = new BaseDAO();
        List<Color> categoryList = new ArrayList<>();
