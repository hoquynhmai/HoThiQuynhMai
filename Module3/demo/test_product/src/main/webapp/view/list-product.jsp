                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="search-box">
                            ...
                            <input type="button" value="Search" class="btn btn-primary"
                                   onclick="submitFormSearchProductPrice()">
                        </div>
                    </div>
                </div>
            </div>
...
<%--                            ${product.color}--%>
                        <td>
                            <c:forEach var="color" items="${colorList}">
                                <c:choose>
                                    <c:when test="${color.id.equals(product.color)}">
                                        ${color.name}
                                    </c:when>
                                </c:choose>
                            </c:forEach>
...
<form method="post" action="/product" id="formSearchProductPrice">
    <input type="hidden" name="actionProduct" value="searchProductPrice">
...
<script>
    ...
    function submitFormSearchProductPrice() {
        let keywordHidden = document.getElementById("keywordProductPriceHidden");
        let keywordDisplay = document.getElementById("keywordProductPriceDisplay");
        keywordHidden.value = keywordDisplay.value;
        document.getElementById("formSearchProductPrice").submit();
    }
